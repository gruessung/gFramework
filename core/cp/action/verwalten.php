<?php
  ...
  */
  ...
  if ($num != 1) {
    trigger_error("Die ID ist nicht vorhanden und/oder mehrmals vergeben. Dies macht eine eindeutige Identifikation unm�glich.",E_USER_ERROR);
  }
  ...
  */
  ...
  /*
  F�r mich ist die Sache damit erledigt :)
  */